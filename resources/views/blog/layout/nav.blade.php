            ...
            <nav class="navbar navbar-expand-lg header-nav-bar">
                ...
                <div class="collapse navbar-collapse hover-dropdown font-14 ml-auto" id="navigation">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a href="/" class="nav-link">اخبار و مقالات</a> </li>
                        <li class="nav-item"><a href="/" class="nav-link">نمونه کارها</a> </li>
                        <li class="nav-item"><a href="/" class="nav-link">ثبت سفارش</a> </li>
                        <li class="nav-item"><a href="/" class="nav-link">ازتباط با ما </a> </li>
