							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-6">
									<div class="small-features-box mb-4 aos-init" data-aos="fade-up" data-aos-duration="1200">
										...
										<h4 class="small-features-caption">بازاریابی حسابداری</h4>
									</div>
								</div>
								...
								<div class="col-lg-6 col-md-6">
									<div class="small-features-box mb-4 aos-init" data-aos="fade-up" data-aos-duration="1200">
										...
										<h4 class="small-features-caption">اعتبار بازیابی</h4>
									</div>
								</div>
								...
								<div class="col-lg-6 col-md-6">
									<div class="small-features-box mb-4 aos-init" data-aos="fade-down" data-aos-duration="1200">
										...
										<h4 class="small-features-caption">تحقیق کلید واژه</h4>
									</div>
								</div>
								...
								<div class="col-lg-6 col-md-6">
									<div class="small-features-box mb-4 aos-init" data-aos="fade-down" data-aos-duration="1200">
										...
										<h4 class="small-features-caption">استراتژی جستجو محلی</h4>
									</div>
								</div>
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 col-sm-12 p-0">
							<div class="image-block-content bg-theme inverse-color">
								<h2>چرا مردم تم ایکس را دوست دارند؟</h2>
								<p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد </p>
								<ul class="simple-list">
									<li>ما ویژگی های قدرتمندی را ارائه می دهیم</li>
									<li>ما عاشق مشتریانمان هستیم</li>
									<li>به ما بپیوندید و بهترین پیشنهاد را بدست آورید</li>
									<li>پشتیبانی ما برای مشتریان ما بسیار اختصاص یافته است</li>
									<li>ما پشتیبانی 24x7 با پیشنهاد گسترده ارائه می دهیم</li>
								</ul>
							</div>
						</div>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12">
							<h2>چرا <span class="text-primary">35،000 نفر</span> به تم ایکس اعتماد کردند؟</h2>
							...
							<ul class="list-style style-1">
								<li>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون</li>
